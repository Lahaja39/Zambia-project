...
echo "<script> .toastr('login success', 3000, 'rounded') </script>";


}
else {

  $query = "SELECT * from friends where Friend_email='$customer_email'";
  $Count_resulti = mysqli_query($con, $query);

  if (mysqli_num_rows($Count_resulti) > 0){
